...
export const ReportsClient: React.FC<ReportsClientProps> = ({
  ...
  const [currentMonth, setCurrentMonth] = useState<string>(defaultYm);
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 pb-24 md:pb-12 max-w-5xl mx-auto w-full px-4 sm:px-6 pt-5">
        ...
        {/* Section 1: Monthly Collection Report */}
        <div className="mt-6">
        ...
        {/* Section 2: Outstanding Fees by Student */}
        <div className="mt-8">
        ...
        {/* Section 3: Student-Wise Historical Summary */}
        <div className="mt-8">
          <h2 className="font-bold text-base text-slate-900 mb-3 flex items-center gap-2">
